...
export const AMBASSADORS: Ambassador[] = [
  {
    ...
    highlight:
      "She builds confidence before the shutter: the same clarity PosePerfect puts on the floor.",
  ...
  },
  {
    ...
    highlight:
      "Corporate and branding days reward photographers who systematize stance.",
  ...
  },
  {
    ...
    highlight:
      "When your career is built on precise posing direction, you understand: the shot starts with the feet.",
